...
Original file is located at
    https://colab.research.google.com/drive/1sRKBPCOzNUhGhHMW04pyFWHKRds9pItp
...
numbers_list = [500000, 1800000, 1200000]
labels_list = ["Deaths", "Total Cases", "Cured"]
plt.pie(numbers_list,labels=labels_list,startangle=None)
plt.show()
